...
try:
    ...
    django_proc = subprocess.Popen(
        [r"C:/Users/bagon/OneDrive/Desktop/nereliacines/env/Scripts/python.exe", "front/manage.py", "runserver", "0.0.0.0:8000"]
    )
    processes.append(django_proc)

    # Start Flask
    flask_proc = subprocess.Popen(
        [r"C:/Users/bagon/OneDrive/Desktop/nereliacines/env/Scripts/python.exe", "-m", "backend.app.app"]
    )
